...
export const familySpecialtyAreas = [
  {
    title: "Conflits familiaux",
    description:
      "Résolution des tensions et amélioration de la communication entre les membres de la famille.",
  },
  {
    title: "Difficultés parentales",
    description:
      "Soutien à la parentalité et développement de stratégies éducatives adaptées.",
  },
  {
    title: "Crises d'adolescence",
    description:
      "Accompagnement des familles face aux défis spécifiques de l'adolescence.",
  },
  {
    title: "Recompositions familiales",
    description:
      "Aide à l'intégration et à l'adaptation lors de la formation de familles recomposées.",
  },
  {
    title: "Deuil et séparations",
    description:
      "Soutien lors des transitions difficiles et des périodes de deuil familial.",
  },
  {
