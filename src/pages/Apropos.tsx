                ...
                <section id={sectionIds.contact} className="py-20 px-6  bg-[#FCF6E9]">
                    <div className="container mx-auto max-w-5xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            ...
                            {/* Social Media */}
                            <motion.div
                                className="bg-stone-50 border-1 p-4 sm:p-6 border-[#25926C]/10  rounded-sm shadow-sm shadow-[#25926C]/10"
                                initial={{ opacity: 0, x: 20 }}
                                whileInView={{ opacity: 1, x: 0 }}
                                transition={{ duration: 0.6 }}
                                viewport={{ once: true }}
                            >
                                ...
                                <div className="grid grid-cols-2 gap-1 sm:gap-6">
                                    ...
                                    <a
                                        href="https://www.instagram.com/carole_lagardere/"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex items-center p-2 sm:p-4 bg-white border border-stone-200 rounded-sm hover:shadow-md transition-shadow"
                                    >
